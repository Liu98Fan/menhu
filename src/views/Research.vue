    ...
    <div id="research">
        ...
        <div class="research-box" >
            <a-card  v-for="(item,index) in researchList" :key="index" :loading="loading" hoverable class="research-card">
                ...
                <img src="../assets/research1.jpg" align="left" hspace="15" vspace="5" :alt="item.title">
